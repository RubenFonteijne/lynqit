...
export default function PricingPage() {
  ...
  const features = [
    { name: "Links to social media", free: true, start: true, pro: true },
    { name: "Featured links", free: false, start: "2", pro: "4" },
    { name: "Customizable links", free: "5", start: "10", pro: "20" },
    { name: "Statistics", free: true, start: true, pro: true },
    { name: "Contact details", free: false, start: true, pro: true },
    { name: "Call-to-action", free: false, start: true, pro: true },
    { name: "Template selection", free: false, start: false, pro: true },
